	...
	private function init_core() {
		$this->info->core = [
			...
			'activity'      => [
				...
				"icon"                 => '<svg height="55px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>',
				"description"          => esc_html__(
		...
		if( isset( WPF()->ai_client ) && WPF()->ai_client->is_service_available() ) {
			$this->info->core['ai'] = [
				...
				"options"              => [
					...
					"search_language"    => [
						"type"                 => "select",
						"label"                => esc_html__( "Default AI Response Language", "wpforo" ),
						"label_original"       => "Default AI Response Language",
						"description"          => esc_html__(
							"Select the default language for AI-generated responses. This setting is used when user preferences are not available.",
							"wpforo"
						),
						"description_original" => "Select the default language for AI-generated responses. This setting is used when user preferences are not available.",
						"variants"             => [
